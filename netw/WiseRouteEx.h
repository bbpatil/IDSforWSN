...
#ifndef wiserouteex_h
#define wiserouteex_h
 ...
 **/
class MIXIM_API WiseRouteEx : public BaseNetwLayer
{
private:
	/** @brief Copy constructor is not allowed.
	 */
	WiseRouteEx(const WiseRouteEx&);
	/** @brief Assignment operator is not allowed.
	 */
	WiseRouteEx& operator=(const WiseRouteEx&);
...
//    int myNetwAddr;
     ...
     */
    floodTypes updateFloodTable(bool isFlood, const tFloodTable::key_type& srcAddr, const tFloodTable::key_type& destAddr, unsigned long seqNum, bool goodLink);
